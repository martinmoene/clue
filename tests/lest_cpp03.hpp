...
#define lest_EXPECT( expr ) \
    do { \
        ...
        { \
            ...
            { \
                lest::report( lest_env.os, lest::failure( lest_LOCATION, #expr, score.decomposition ), lest_env.context() ); \
...
#define lest_EXPECT_NOT( expr ) \
    do { \
        ...
        { \
            ...
            { \
                lest::report( lest_env.os, lest::failure( lest_LOCATION, lest::not_expr( #expr ), lest::not_expr( score.decomposition ) ), lest_env.context() ); \
